...
We will use additional NPM libraries to use Multer with S3. The following assumes we already have Multer installed and configured from the [previous file upload exercise.](../2.3-express.js/2.3.5-file-uploads.md)
