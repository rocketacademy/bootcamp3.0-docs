...
![VS Code gives us buttons above each conflict to conveniently resolve each conflict.](<../../.gitbook/assets/0.2.1 - Branches - Merge - Resolve Conflict (1).png>)
...
![Entering git commit after adding resolved files to staging area will open a commit message window. Save and close the file to complete commit.](<../../.gitbook/assets/0.2.1 - Branches - Merge - Resolve Conflict.png>)
