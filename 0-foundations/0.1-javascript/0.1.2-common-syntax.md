...
Open the console in Chrome DevTools. Enter `const` examples above to get relevant errors. What do the error messages say?

### Arrow Functions

Go back to an old piece of code you've written. Change the function definition to use arrow functions in one place that you can easily test. You can change the definition of the `main` function in any old code from Coding Basics.
