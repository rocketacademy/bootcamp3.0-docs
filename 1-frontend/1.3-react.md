...
#### Additional Setup for Windows machines (<mark style="color:red;">If your application doesn't automatically reflect saved changed after npm start</mark>)
...
This will mean that when you run the `npm start` command the React application will use polling, any changes you make while running the app will be reflected in the browser after a few seconds.&#x20;
