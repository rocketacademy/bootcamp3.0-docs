...
This exercise introduces the most common HTML elements we'll use during SWE Bootcamp. The exercise also covers `<form>` and various form input tags, which we won't use until later in the course.
