...
Fork and clone the [Coding Bootcamp Tic Tac Toe repo](https://github.com/rocketacademy/tictactoe-bootcamp). Incorporate the code below to build a working Tic Tac Toe game.
