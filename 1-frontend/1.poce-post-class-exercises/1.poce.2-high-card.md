...
Start with [Rocket's High Card repo](https://github.com/rocketacademy/high-card-bootcamp) (Rocket-themed blank Create React App) and add code to create High Card.&#x20;
