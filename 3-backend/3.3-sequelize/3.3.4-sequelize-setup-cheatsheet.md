# 3.3.4: Sequelize Setup Cheatsheet
...
## [Setup Packages and Folders](broken-reference)
...
## [One-to-Many Associations](3.3.1-sequelize-1-m-relationships.md)
...
## [Many-to-Many Associations](3.3.2-sequelize-m-m-relationships.md)
