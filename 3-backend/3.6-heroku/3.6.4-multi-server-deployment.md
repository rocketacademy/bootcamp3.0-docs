...
Create React App deployment works slightly differently from regular Heroku development. Please follow the Heroku Deployment instructions in CRA Docs [here](https://create-react-app.dev/docs/deployment/#heroku) to deploy CRA apps.
