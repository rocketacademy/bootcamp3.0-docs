...
3. Use the code from [2.5.2.2: PostgreSQL Node App](../3.4-sql-applications/3.2.2.2-postgresql-node-app.md#select) as a template for `index.js`. Reminder to update `pgConnectionConfigs` to reference the new DB name.
...
For the following 2 features you will have to use nested SQL queries. Refer to [2.5.3.1: Nested SQL Queries](../3.2-sql/3.2.3-sql-techniques/3.2.3.1-nested-sql-queries.md) for examples. Feel free to output the data in any readable format.
