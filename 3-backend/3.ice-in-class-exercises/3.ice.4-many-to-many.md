...
3. Use the code from [2.5.2.2: PostgreSQL Node App](../3.4-sql-applications/3.2.2.2-postgresql-node-app.md#select) as a template for `index.js`. Remember to update `pgConnectionConfigs` to reference the new DB name.
