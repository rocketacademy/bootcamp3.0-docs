...
1. Use the[ ](../2.1-computer-networking/2.1.3-http-file-server.md)[file server code from 2.2.4: HTTP File Server](../2.1-computer-networking/2.1.3-http-file-server.md#index-js) to serve your video poker files instead of a message.
