...
Enable users to report Bigfoot sightings that get saved to our SQL database. When a user next visits the sightings page they should be able to see the sightings they reported.
...
### Create test requests using Thunder Client
...
2. We will sent requests to Thunder Client.
