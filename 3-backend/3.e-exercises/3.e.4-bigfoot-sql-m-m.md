...
To make our form more realistic, add at least 3 categories to our database with POST requests to `/categories` via Thunder Client. These categories can be `rain`, `mountain`, `woods` or any other categories you deem relevant.
