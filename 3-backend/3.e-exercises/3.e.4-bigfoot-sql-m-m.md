...
8. Add a `production` Sequelize config to our `config/database.js` file below our `development` config. Rocket's config is copied below. This is what our app needs to access Heroku Postgres.
