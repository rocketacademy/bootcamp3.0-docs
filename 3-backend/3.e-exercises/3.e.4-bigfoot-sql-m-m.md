...
Here is reference code for the [frontend](https://github.com/rocketacademy/bigfoot-frontend-bootcamp/tree/solution-sql-m-m-base/src/components) and the [backend](https://github.com/rocketacademy/bigfoot-sql-backend-bootcamp/tree/solution-sql-m-m-base) for this exercise, and here is a [reference deployment](https://bigfoot-solution-deployment.netlify.app/). You can do better!
