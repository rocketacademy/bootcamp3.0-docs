...
In Basics we'll be using the command line mostly to work with our version control program [Git](../0-foundations/broken-reference/). In this course we'll practice the basics of using the command line as an everyday tool to replace simple file actions like name, copying and deleting.
